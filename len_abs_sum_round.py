...
abs() -> Retorna o valor absoluto de um número inteoirpo ou real. De forma básica, seria o seu valor real sem o sinal.
...
sum() -> Recebe como parâmetro um iterável, podendo receber um valor inicial e rtetorna a soma total dos elementos,
