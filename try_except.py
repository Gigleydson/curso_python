...
que o programa pare de funcionar e o usuário receba mensagens de erro iniesperadas.
...
try:
    ...
    print(f'A aplicação gerou o seghuinte erro: {err}')


# Exemplo 5 - Podemos efetuar diversos tratamentos de rros de uma vez.

try:
    geek()
except NameError as erra:
    print(f'A aplicação gerou o seghuinte erro: {erra}')
except TypeError as errb:
    print(f'A aplicação gerou o seghuinte erro: {errb}')
except:
    print('Deu um erro diferente')
"""

# Exemplo de função com tratamento expecífico de erros.
